...
%(excluding we will use a synchronize/OS Mutex or alike/or a synchronized queue). Even more important, if we would rely on mutexes, the code complexity will be very high and especially debugging this code.
