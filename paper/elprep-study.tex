...
For a set of 20K rows the tags before would be mostly on the size of an Object type that stores some values, which would mean around 16 bytes per instance vs 2 bytes per instance.
}
