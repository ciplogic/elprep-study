...
%and the indices would in fact store the equivalent data with the pointer: so book keeping would be on average: (length * 1 + index * 10) : 4 + 2*10 = 24 bytes, a 10x saving.
