...
public class StringScanner {
    ...
    public Field parseSamInteger(Slice tag) {
        readUntil('\t');
        return new IntegerField(tag, Integer.parseInt(sliceResult, 0, sliceResult.length(), 10));
    }
    ...
    public int doInt() {
        doSlice();
        return Integer.parseInt(sliceResult, 0, sliceResult.length(), 10);
    }
